...
const styles = StyleSheet.create({
  ...
  confirmAmount: { fontFamily: 'SpaceGrotesk-Bold', fontSize: tokens.font.heading, letterSpacing: -0.5, color: tokens.white100 },
  ...
  statusText: { fontFamily: 'SpaceGrotesk-Bold', fontSize: tokens.font.sectionHeader, letterSpacing: -0.5, color: tokens.white100 },
