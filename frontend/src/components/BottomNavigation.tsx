...
import { Activity, Search, Skull, Bell, Bookmark } from 'lucide-react';
...
export function BottomNavigation({ currentScreen, onScreenChange }: BottomNavigationProps) {
  ...
  const navItems = [
    ...
    { id: 'alerts' as Screen, label: 'Alerts', icon: Bell, badge: unreadCount > 0 ? unreadCount : undefined },
    { id: 'watchlist' as Screen, label: 'Watch', icon: Bookmark },
  ];
