    ...
    <header>
      <nav aria-label="Main navigation" style={{
        ...
        <div className="ff-hide-mobile" style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
          {isLanding ? (
            <>
              <a href="#features" style={linkStyle}>Work</a>
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        ...
        <main id="main-content" style={{ paddingTop: 'calc(53px + 30px)', paddingLeft: 15, paddingRight: 15, paddingBottom: 60, minHeight: '100vh', fontFamily: ff.font }}>
          <Routes>
